...
You will notice we seem to be a bit redundant. A better way to accomplish tasks like these is to open up our code in GHCi. GHCi is the interactive haskell terminal, and is more powerful than you could ever imagine. Once you are in GHCi (there are plenty of tutorials other places). We can directly type 'play myNote' or 'writeMidi "test.mid" myNote' to excecute the commands. This is like the little brother to live coding.
